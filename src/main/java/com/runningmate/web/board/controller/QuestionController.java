...
@Slf4j
   ...
   public String qdwriteAction(@RequestParam("questionTitle") String questionTitle,
       ...
       // Create a new QuestionDto object and set the required properties
...
//    컨트롤러 코드
   ...
   public String deleteAction(@RequestParam("questionId") String questionId, 
       ...
       if (result == 1) {
           ...
           if (category != null) {
               return "<script>alert('글삭제 실패!');location.href= '/qdcontentForm?questionId=" + questionId + "&category=" + category + "'; </script>";
           } else {
               return "<script>alert('글삭제 실패!');location.href= '/qdcontentForm?questionId=" + questionId + "'; </script>";
           }
       }
   }
...
//   @RequestMapping("/questionsDetail")
//   public String questionForm(){
//      return "board/questionsDetail";
//   }
